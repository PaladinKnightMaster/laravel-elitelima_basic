...
<footer>
    <div
        ...
        <div
            class="span12">
            <div
                class="copyright"><?php echo e($footer); ?></div>
            <div
                class="footerMenu"> <a
                    href="<?php echo e(route("home")); ?>" class="">Home</a> &bull; <a
                    href="<?php echo e(route("agency")); ?>" class="">Agency</a> &bull; <a
                    href="<?php echo e(route("sitemap")); ?>">Sitemap</a></div>
        </div>
    </div>
    <div
        class="clearfix"></div>
