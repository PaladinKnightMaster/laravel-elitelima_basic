            ...
            <div class="col-md-12">
                <div class="panel">
                    ...
                    <div class="col-sm-12 " style="background-color: white">
                        {{ Form::open([ 'route' => 'videos.store','class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data',]) }}
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-xs-12 text-center">
                                ...
                                <button type="submit" class="btn btn-sm btn btn-info submit-form-btn" title="Click here to Save">
                                    <i class="fa fa-spinner fa-spin mr-2 d-none"></i><span>Save</span>
                                </button>
                            </div>
                        </div>
                        {{Form::close()}}
