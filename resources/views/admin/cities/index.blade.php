...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel">
                    <div class="panel-heading" style="text-transform: capitalize">Manage {{Request::segment(2)}} <button class="btn btn-danger pull-right" onclick="del_selected()">Delete All</button> <a href="{{route('cities.create')}}" class="btn btn-info pull-right" style="margin-right: 10px">Add New</a></div>
                    <div class="col-sm-12" style="background-color: white">
                        <div class="table-responsive">
                            <form action="{{url('admin/delete-selected-cities')}}" method="post" id="uform">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <table id="city" class="table table-hover manage-u-table table-bordered table-responsive table-striped">
                                    <thead>
                                    <tr>
...
@section('scripts')
    ...
    <script type="text/javascript">
            ...
            swal({
                ...
                function(){
                    var APP_URL = {!! json_encode(url('/')) !!}
                        ...
                        window.location.href = APP_URL+"/admin/cities/delete/"+id;
                });
        ...
        function del_selected(){
            swal({
                ...
                $("#uform").submit();
                setTimeout(function () {
                    swal("Cities deleted sucessfully. Thanks");
                }, 2000);
            });
        }
    </script>
    ...
    <script>
        ...
        var copoun = $('#city').DataTable( {
            "processing": true,
            "serverSide": true,
            "responsive": true,
            "ajax": {
                "url":"{{ route('admin-getAddedCities') }}",
                "dataType":"json",
                "type":"POST",
        ...
        function view(id) {
            ...
            $.post("{{ route('admin-getCities') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
