            ...
            <div class="col-md-12">
                <div class="panel">
                    ...
                    <div class="col-sm-12" style="background-color: white">
                        {{ Form::model($page, ['method' => 'PATCH','route' => ['pages.update', $page->id],'class'=>'form-horizontal','role'=>'form']) }}
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <div class="form-group {{ $errors->has('slug') ? 'has-error' : '' }}">
                                {!! Form::label('Slug:') !!}
                                {{ Form::text('slug', null, ['class' => 'form-control','id'=>'category']) }}
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <div class="form-group {{ $errors->has('page_link') ? 'has-error' : '' }}">
                                ...
                                {{ Form::text('page_link', null, ['class' => 'form-control','id'=>'category']) }}
                                <span class="text-danger">{{ $errors->first('page_link') }}</span>
                            </div>
                        </div>
                        <div class="col-md-6 col-md-offset-3">
                            <div class="form-group {{ $errors->has('visible') ? 'has-error' : '' }}">
                                ...
                                <select name="visible" id="" class="form-control">
                                    <option value="1" <?php if ($page->visible == 1){echo "selected";} ?>>Yes</option>
                                    <option value="0" <?php if ($page->visible == 0){echo "selected";} ?>>No</option>
                                </select>
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <div class="form-group {{ $errors->has('language') ? 'has-error' : '' }}">
                                ...
                                <select name="language" id="" class="form-control">
                                    <option value="en" <?php if ($page->language == 'en'){echo "selected";} ?>>English</option>
                                    <option value="es" <?php if ($page->language == 'es'){echo "selected";} ?>>Spanish</option>
                                </select>
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-xs-12 text-center">
                                <a class="btn btn-danger btn-sm" href="{{ route('pages.index') }}">
