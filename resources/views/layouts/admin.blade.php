...
<head>
    ...
    <?php $settings = \App\Setting::pluck('value','name')->toArray(); $favicon = $settings['favicon']; $site_title = $settings['site_title']; ?>

    <link rel="icon" type="image/png" sizes="16x16" href="{{asset("uploads/$favicon")}}">
