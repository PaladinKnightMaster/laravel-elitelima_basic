            ...
            <div class="col-md-12">
                <div class="panel">
                    ...
                    <div class="col-sm-12" style="background-color: white">
                        {{ Form::model($city, ['method' => 'PATCH','route' => ['cities.update', $city->id],'class'=>'form-horizontal','role'=>'form']) }}
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <div class="form-group {{ $errors->has('country') ? 'has-error' : '' }}">
                                ...
                                {{  Form::select('country', $countries,$city->country_id, ['class' => 'form-control'])  }}
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-xs-12 text-center">
                                <a class="btn btn-danger btn-sm" href="{{ route('cities.index') }}">
