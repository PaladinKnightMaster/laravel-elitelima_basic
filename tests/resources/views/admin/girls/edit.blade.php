                                    ...
                                    <div class="radio-list">
                                        <label class="radio-inline p-0">
                                            <div class="radio radio-info">
                                                <input type="radio" name="type" id="radio1" value="independent" <?php if($girl->type == "independent"){ echo "checked"; }else{echo "";} ?>>
                                                <label for="radio1">Independent</label>
                                            </div>
                                        </label>
                                        <label class="radio-inline">
                                            <div class="radio radio-info">
                                                <input type="radio" name="type" id="radio2" value="agency" <?php if($girl->type == "agency"){ echo "checked"; }else{echo "";} ?>>
                            ...
                            <div class="col-md-4 margin-top">
                                <div class=" {{ $errors->has('drinking') ? 'has-error' : '' }}">
                                    ...
                                    <select name="drinking" id="" class="form-control">
                                        <option value="0" <?php if($girl->drinking == 0){ echo "selected"; }else{echo "";} ?>>No</option>
                                        <option value="1" <?php if($girl->drinking == 1){ echo "selected"; }else{echo "";} ?>>Yes</option>
                                    </select>
                            ...
                            <div class="col-md-4 margin-top">
                                <div class=" {{ $errors->has('smoking') ? 'has-error' : '' }}">
                                    ...
                                    <select name="smoking" id="" class="form-control">
                                        <option value="0" <?php if($girl->smoking == 0){ echo "selected"; }else{echo "";} ?>>No</option>
                                        <option value="1" <?php if($girl->smoking == 1){ echo "selected"; }else{echo "";} ?>>Yes</option>
                                    </select>
                            ...
                            <div class="col-md-4 margin-top">
                                <div class=" {{ $errors->has('kissing') ? 'has-error' : '' }}">
                                    ...
                                    <div class="radio-list">
                                        <label class="radio-inline p-0">
                                            <div class="radio radio-info">
                                                <input type="radio" name="kissing" id="kissing1" value="1" <?php if($girl->kissing == 1){ echo "checked"; }else{echo "";} ?>>
                                                <label for="kissing1">Yes</label>
                                            </div>
                                        </label>
                                        <label class="radio-inline">
                                            <div class="radio radio-info">
                                                <input type="radio" name="kissing" id="kissing2" value="0" <?php if($girl->kissing == 0){ echo "checked"; }else{echo "";} ?>>
                            ...
                            <div class="col-md-4 margin-top">
                                <div class=" {{ $errors->has('blow_job') ? 'has-error' : '' }}">
                                    ...
                                    <div class="radio-list">
                                        <label class="radio-inline p-0">
                                            <div class="radio radio-info">
                                                <input type="radio" name="blow_job" id="blow_job1" value="0"  <?php if($girl->blow_job == 0){ echo "checked"; }else{echo "";} ?>>
                                                <label for="blow_job1">Natural</label>
                                            </div>
                                        </label>
                                        <label class="radio-inline">
                                            <div class="radio radio-info">
                                                <input type="radio" name="blow_job" id="blow_job2" value="1" <?php if($girl->blow_job == 1){ echo "checked"; }else{echo "";} ?>>
                            ...
                            <div class="col-md-4 margin-top">
                                <div class=" {{ $errors->has('parejas') ? 'has-error' : '' }}">
                                    ...
                                    <div class="radio-list">
                                        <label class="radio-inline p-0">
                                            <div class="radio radio-info">
                                                <input type="radio" name="parejas" id="parejas1" value="1"  <?php if($girl->parejas == 1){ echo "checked"; }else{echo "";} ?>>
                                                <label for="parejas1">Yes</label>
                                            </div>
                                        </label>
                                        <label class="radio-inline">
                                            <div class="radio radio-info">
                                                <input type="radio" name="parejas" id="parejas2" value="0" <?php if($girl->parejas == 0){ echo "checked"; }else{echo "";} ?>>
                            ...
                            <div class="col-md-4 margin-top">
                                <div class=" {{ $errors->has('sixty_nine') ? 'has-error' : '' }}">
                                    ...
                                    <div class="radio-list">
                                        <label class="radio-inline p-0">
                                            <div class="radio radio-info">
                                                <input type="radio" name="sixty_nine" id="sixty_nine1" value="1" <?php if($girl->sixty_nine == 1){ echo "checked"; }else{echo "";} ?>>
                                                <label for="sixty_nine1">Yes</label>
                                            </div>
                                        </label>
                                        <label class="radio-inline">
                                            <div class="radio radio-info">
                                                <input type="radio" name="sixty_nine" id="sixty_nine2" value="0" <?php if($girl->sixty_nine == 0){ echo "checked"; }else{echo "";} ?>>
                            ...
                            <div class="col-md-4 margin-top">
                                <div class=" {{ $errors->has('anal') ? 'has-error' : '' }}">
                                    ...
                                    <div class="radio-list">
                                        <label class="radio-inline p-0">
                                            <div class="radio radio-info">
                                                <input type="radio" name="anal" id="anal1" value="1" <?php if($girl->anal == 1){ echo "checked"; }else{echo "";} ?>>
                                                <label for="anal1">Yes</label>
                                            </div>
                                        </label>
                                        <label class="radio-inline">
                                            <div class="radio radio-info">
                                                <input type="radio" name="anal" id="anal2" value="0" <?php if($girl->anal == 0){ echo "checked"; }else{echo "";} ?>>
                            ...
                            <div class="col-md-4 margin-top">
                                <div class=" {{ $errors->has('messenger_type') ? 'has-error' : '' }}">
                                    ...
                                    <select name="messenger_type" id="" class="form-control">
                                        <option value="0" <?php if($girl->messenger_type == 0){ echo "selected"; }else{echo "";} ?>></option>
                                        <option value="3" <?php if($girl->messenger_type == 3){ echo "selected"; }else{echo "";} ?>>AIM&nbsp;</option>
                                        <option value="4" <?php if($girl->messenger_type == 4){ echo "selected"; }else{echo "";} ?>>Google Talk&nbsp;</option>
                                        <option value="6" <?php if($girl->messenger_type == 6){ echo "selected"; }else{echo "";} ?>>ICQ&nbsp;</option>
                                        <option value="2" <?php if($girl->messenger_type == 2){ echo "selected"; }else{echo "";} ?>>MSN Messenger&nbsp;</option>
                                        <option value="5" <?php if($girl->messenger_type == 5){ echo "selected"; }else{echo "";} ?>>Skype&nbsp;</option>
                                        <option value="1" <?php if($girl->messenger_type == 1){ echo "selected"; }else{echo "";} ?>>Yahoo Messenger&nbsp;</option>
                                    </select>
                                        ...
                                        <div class="input_image_fields">
                                            @foreach($girl->images as $image)
                                                <div class="col-sm-12" style="position:relative">
                                                    ...
                                                    <div class=" ">
                                                         <label for="">EN</label>
                                                        <input type="text" name="" value="{{$image->en}}" class="form-control" readonly>
                                                    </div>
                                                    </div>
                                                    <div class="col-md-2 margin-top">
                                                        <div class=" ">
                                                            <label for="">FR</label>
                                                            <input type="text" name="" value="{{$image->fr}}"  class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 margin-top">
                                                    <div class=" ">
                                                        <label for="">ES</label>
                                                        <input type="text" name="" value="{{$image->es}}"  class="form-control" readonly>
                                                    </div>
                                                    </div>
                                                    <div class="col-md-2 margin-top">
                                                         <div class=" ">
                                                            <label for="">DE</label>
                                                            <input type="text" name="" value="{{$image->de}}"  class="form-control" readonly>
                                                         </div>
                                                    </div>
                                                    <div class="col-md-2 margin-top">
                                                        <div class=" ">
                                                             <label for="">IT</label>
                                                             <input type="text" name="" value="{{$image->it}}"  class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endforeach
